  ...
  return (
    ...
    >
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="relative inline-flex h-14 rounded-full bg-[#25d366] text-white px-4 gap-2 items-center justify-center shadow-xl hover:scale-110 transition-transform"
      >
        <span
        ...
        <span className="relative text-xs uppercase tracking-[0.18em] font-semibold">
          WhatsApp
        </span>
      </a>
